...
START_TEST(s21_ceil_f) {
  double value1 = 1.5;
  ck_assert_double_eq(s21_ceil(value1), ceil(value1));
  double value2 = 0.45;
  ck_assert_double_eq(s21_ceil(value2), ceil(value2));
  double value3 = -3.01;
  ck_assert_double_eq(s21_ceil(value3), ceil(value3));
  double value4 = -0;
  ck_assert_double_eq(s21_ceil(value4), ceil(value4));
  double value5 = 1234567;
  ck_assert_double_eq(s21_ceil(value5), ceil(value5));
}
END_TEST

START_TEST(s21_floor_f) {
  double value1 = 1.5;
  ck_assert_double_eq(s21_floor(value1), floor(value1));
  double value2 = 0.45;
  ck_assert_double_eq(s21_floor(value2), floor(value2));
  double value3 = -3.01;
  ck_assert_double_eq(s21_floor(value3), floor(value3));
  double value4 = -0.;
  ck_assert_double_eq(s21_floor(value4), floor(value4));
  double value5 = -0;
  ck_assert_double_eq(s21_floor(value5), floor(value5));
}
END_TEST
...
START_TEST(s21_exp_f) {
  ...
  ck_assert_double_eq(s21_exp(-2), exp(-2));
  ck_assert_double_eq(s21_exp(1234567), exp(1234567));
  ck_assert_double_eq(s21_exp(-1234567), exp(-1234567));
...
START_TEST(s21_fabs_f) {
  ck_assert_double_eq(s21_fabs(-612367.54783), fabs(-612367.54783));
  ck_assert_double_eq(s21_fabs(-45.345), fabs(-45.345));
